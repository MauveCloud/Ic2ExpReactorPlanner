...
public class ComponentFactory {
    ...
    private static final ReactorItem[] ITEMS = {
        ...
        new FuelRod(1, "fuelRodUranium", getI18n("ComponentName.FuelRodUranium"), TextureFactory.getImage("reactorUraniumSimple.png", "uranium.png"), 20e3, 1, null, 
                MaterialsList.FUEL_ROD_URANIUM, 100, 2, 1, false),
        new FuelRod(2, "dualFuelRodUranium", getI18n("ComponentName.DualFuelRodUranium"), TextureFactory.getImage("reactorUraniumDual.png", "dual_uranium.png"), 20e3, 1, null, 
                MaterialsList.DUAL_FUEL_ROD_URANIUM, 200, 4, 2, false),
        new FuelRod(3, "quadFuelRodUranium", getI18n("ComponentName.QuadFuelRodUranium"), TextureFactory.getImage("reactorUraniumQuad.png", "quad_uranium.png"), 20e3, 1, null, 
                MaterialsList.QUAD_FUEL_ROD_URANIUM, 400, 8, 4, false),
        new FuelRod(4, "fuelRodMox", getI18n("ComponentName.FuelRodMox"), TextureFactory.getImage("reactorMOXSimple.png", "mox.png"), 10e3, 1, null, 
                MaterialsList.FUEL_ROD_MOX, 100, 2, 1, true),
        new FuelRod(5, "dualFuelRodMox", getI18n("ComponentName.DualFuelRodMox"), TextureFactory.getImage("reactorMOXDual.png", "dual_mox.png"), 10e3, 1, null, 
                MaterialsList.DUAL_FUEL_ROD_MOX, 200, 4, 2, true),
        new FuelRod(6, "quadFuelRodMox", getI18n("ComponentName.QuadFuelRodMox"), TextureFactory.getImage("reactorMOXQuad.png", "quad_mox.png"), 10e3, 1, null, 
                MaterialsList.QUAD_FUEL_ROD_MOX, 400, 8, 4, true),
        new Reflector(7, "neutronReflector", getI18n("ComponentName.NeutronReflector"), TextureFactory.getImage("reactorReflector.png", "neutron_reflector.png"), 10e3, 1, null, 
                MaterialsList.NEUTRON_REFLECTOR),
        new Reflector(8, "thickNeutronReflector", getI18n("ComponentName.ThickNeutronReflector"), TextureFactory.getImage("reactorReflectorThick.png", "thick_neutron_reflector.png"), 40e3, 1, null, 
                MaterialsList.THICK_NEUTRON_REFLECTOR),
        new Vent(9, "heatVent", getI18n("ComponentName.HeatVent"), TextureFactory.getImage("reactorVent.png", "heat_vent.png"), 1, 1000, null, 
                MaterialsList.HEAT_VENT, 6, 0, 0),
        new Vent(10, "advancedHeatVent", getI18n("ComponentName.AdvancedHeatVent"), TextureFactory.getImage("reactorVentDiamond.png", "advanced_heat_vent.png"), 1, 1000, null, 
                MaterialsList.ADVANCED_HEAT_VENT, 12, 0, 0),
        new Vent(11, "reactorHeatVent", getI18n("ComponentName.ReactorHeatVent"), TextureFactory.getImage("reactorVentCore.png", "reactor_heat_vent.png"), 1, 1000, null, 
                MaterialsList.REACTOR_HEAT_VENT, 5, 5, 0),
        new Vent(12, "componentHeatVent", getI18n("ComponentName.ComponentHeatVent"), TextureFactory.getImage("reactorVentSpread.png", "component_heat_vent.png"), 1, 1, null, 
                MaterialsList.COMPONENT_HEAT_VENT, 0, 0, 4),
        new Vent(13, "overclockedHeatVent", getI18n("ComponentName.OverclockedHeatVent"), TextureFactory.getImage("reactorVentGold.png", "overclocked_heat_vent.png"), 1, 1000, null, 
        ...
        new Exchanger(17, "heatExchanger", getI18n("ComponentName.HeatExchanger"), TextureFactory.getImage("reactorHeatSwitch.png", "heat_exchanger.png"), 1, 2500, null, 
                MaterialsList.HEAT_EXCHANGER, 12, 4),
        new Exchanger(18, "advancedHeatExchanger", getI18n("ComponentName.AdvancedHeatExchanger"), TextureFactory.getImage("reactorHeatSwitchDiamond.png", "advanced_heat_exchanger.png"), 1, 10e3, null, 
                MaterialsList.ADVANCED_HEAT_EXCHANGER, 24, 8),
        new Exchanger(19, "coreHeatExchanger", getI18n("ComponentName.ReactorHeatExchanger"), TextureFactory.getImage("reactorHeatSwitchCore.png", "reactor_heat_exchanger.png"), 1, 5000, null, 
                MaterialsList.REACTOR_HEAT_EXCHANGER, 0, 72),
        new Exchanger(20, "componentHeatExchanger", getI18n("ComponentName.ComponentHeatExchanger"), TextureFactory.getImage("reactorHeatSwitchSpread.png", "component_heat_exchanger.png"), 1, 5000, null, 
                MaterialsList.COMPONENT_HEAT_EXCHANGER, 36, 0),
        new Plating(21, "reactorPlating", getI18n("ComponentName.ReactorPlating"), TextureFactory.getImage("reactorPlating.png", "plating.png"), 1, 1, null, 
                MaterialsList.REACTOR_PLATING, 1000, 0.9025),
        new Plating(22, "heatCapacityReactorPlating", getI18n("ComponentName.HeatCapacityReactorPlating"), TextureFactory.getImage("reactorPlatingHeat.png", "heat_plating.png"), 1, 1, null, 
                MaterialsList.HEAT_CAPACITY_REACTOR_PLATING, 1700, 0.9801),
        new Plating(23, "containmentReactorPlating", getI18n("ComponentName.ContainmentReactorPlating"), TextureFactory.getImage("reactorPlatingExplosive.png", "containment_plating.png"), 1, 1, null, 
        ...
        new FuelRod(26, "fuelRodThorium", getI18n("ComponentName.FuelRodThorium"), TextureFactory.getImage("gt.Thoriumcell.png"), 50e3, 1, "GT5.08", 
                MaterialsList.FUEL_ROD_THORIUM, 40, 0.5, 1, false),
        new FuelRod(27, "dualFuelRodThorium", getI18n("ComponentName.DualFuelRodThorium"), TextureFactory.getImage("gt.Double_Thoriumcell.png"), 50e3, 1, "GT5.08", 
                MaterialsList.DUAL_FUEL_ROD_THORIUM, 80, 1, 2, false),
        new FuelRod(28, "quadFuelRodThorium", getI18n("ComponentName.QuadFuelRodThorium"), TextureFactory.getImage("gt.Quad_Thoriumcell.png"), 50e3, 1, "GT5.08", 
        ...
        new FuelRod(36, "fuelRodNaquadah", getI18n("ComponentName.FuelRodNaquadah"), TextureFactory.getImage("gt.Naquadahcell.png"), 100e3, 1, "GT5.09", 
                MaterialsList.FUEL_ROD_NAQUADAH, 100, 2, 1, true),
        new FuelRod(37, "dualFuelRodNaquadah", getI18n("ComponentName.DualFuelRodNaquadah"), TextureFactory.getImage("gt.Double_Naquadahcell.png"), 100e3, 1, "GT5.09", 
                MaterialsList.DUAL_FUEL_ROD_NAQUADAH, 200, 4, 2, true),
        new FuelRod(38, "quadFuelRodNaquadah", getI18n("ComponentName.QuadFuelRodNaquadah"), TextureFactory.getImage("gt.Quad_Naquadahcell.png"), 100e3, 1, "GT5.09", 
