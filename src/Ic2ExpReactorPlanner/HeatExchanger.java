...
public class HeatExchanger extends ReactorComponent {
    ...
    public static final MaterialsList MATERIALS = new MaterialsList(MaterialsList.ELECTRONIC_CIRCUIT, 3, BUNDLE.getString("MaterialName.Tin"), 5, BUNDLE.getString("MaterialName.Copper"));
